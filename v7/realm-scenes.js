(function(root){
  ...
  Scenes.prototype.backdrop=function(g,o){
    ...
    if(o.id==="moon-rome")image=this.image("moonRome","v7/assets/realm-moon-rome-v1-native.png");
    if(o.id==="sunset-rome")image=this.image(h>w?"sunsetPortrait":"sunset",h>w?"v7/assets/realm-sunset-rome-portrait-v1-native.png":"assets/greek-sunset-realm-px.png");
    if(o.id==="snow")image=this.image("snow","assets/snow-peaks-realm-px.png");
    if(o.id==="blossom")image=this.image(h>w?"blossomValley":"blossomWide",h>w?"v7/assets/realm-blossom-valley-v1-native.png":"v7/assets/realm-blossom-valley-wide-v1-native.png");
  ...
  Scenes.prototype.cherryDepth=function(g,o){
    ...
    var image=this.image("cherry","v7/assets/realm-cherry-tree-v1-native.png");
